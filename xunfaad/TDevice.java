...
public class TDevice {
	...
	// String udid = context.getPreferences().getString("udid",
	// "");
	// if (udid.length() == 0) {
	// SharedPreferences.Editor editor = context.getPreferences()
	// .edit();
	...
	public static void openCamera(Context context) {
		Intent intent = new Intent(); // 璋冪敤鐓х浉鏈�
	...
	public static int getStatuBarHeight() {
		...
		Object obj = null;
		Field field = null;
		int x = 0, sbar = 38;// 榛樿涓�38锛岃矊浼煎ぇ閮ㄥ垎鏄繖鏍风殑
		try {
			c = Class.forName("com.android.internal.R$dimen");
			obj = c.newInstance();
			field = c.getField("status_bar_height");
